...
export async function exportCanvasProjects(projects: CanvasProject[], fileName = "Freedom") {
    ...
    const data: CanvasExportFile = { app: "freedom", version: 3, exportedAt: new Date().toISOString(), projects: exportedProjects };
