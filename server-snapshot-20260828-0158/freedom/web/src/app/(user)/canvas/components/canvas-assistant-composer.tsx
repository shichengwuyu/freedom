...
export function CanvasAssistantComposer({
    ...
    const agentTextModel = agentConfig.textModel || effectiveConfig.textModel || effectiveConfig.model || effectiveConfig.textModels?.[0] || "";
                ...
                <div className="mt-2 flex items-center justify-between gap-2">
                    <div className="flex min-w-0 flex-1 items-center gap-1">
                        <ModelPicker
                            ...
                            value={agentTextModel}
                            channelId={agentConfig.textChannelId}
                            capability="text"
                            placeholder="Agent 模型"
