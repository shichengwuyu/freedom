<p align="center">
  <img src="web/public/logo.svg" width="96" alt="freedom logo">
</p>

<h1 align="center">Freedom</h1>

<p align="center">
  <a href="https://github.com/tigerowo/freedom"><img src="https://img.shields.io/github/stars/tigerowo/freedom?style=flat-square&logo=github" alt="GitHub stars"></a>
...
Freedom是一款面向图片，视频，音频，全能创作的开源工作台。它把画布编排、AI 图片、视频、音频生成、参考图编辑、对话助手、提示词库和素材沉淀放在同一个界面里，适合用来探索视觉方案并连续迭代图片结果

<p align="center">
  <img src="web/public/banners/promo-hero.png" alt="Freedom 推广头图" />
</p>

> 🎬 60 秒演示视频：[B站](https://space.bilibili.com/) · [YouTube](https://www.youtube.com/)（录制中，敬请期待）
...
- Freedom：多画布项目、节点拖拽缩放、连线、小地图、撤销重做、导入导出
...
完整功能说明见 [功能介绍](docs/overview/features.md)
...
- 后端：Go、Gin、GORM
- 存储：MySQL、本地 IndexedDB、S3 兼容对象存储、Cloudflare R2  
- 部署：Docker

## 快速开始

```bash
git clone https://github.com/tigerowo/freedom.git
cd freedom
cp .env.example .env
# 修改默认账号密码等信息
...
```text
https://freedom-cpco.onrender.com?apiKey={key}&baseUrl={address}
```

跳转后会自动打开配置弹窗并填入 API Key 和 Base URL。
如果自己部署了，可以把 `https://freedom-cpco.onrender.com` 替换成你部署的地址。
...
<a href="https://www.star-history.com/?repos=tigerowo%2Ffreedom&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=tigerowo/freedom&type=date&theme=dark&legend=top-left&sealed_token=SMYnxdZ99ogoiNPY5Qaeg1X9nB17KGpOCvv0Pzjz5mLCx5o7pNOpQNnYpk2CIUkdJMuAcxve8H_ZAYllKY4b7YTvZh0tiHoC8hGfknKnk2IUMYhQoIxgcQ" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=tigerowo/freedom&type=date&legend=top-left&sealed_token=SMYnxdZ99ogoiNPY5Qaeg1X9nB17KGpOCvv0Pzjz5mLCx5o7pNOpQNnYpk2CIUkdJMuAcxve8H_ZAYllKY4b7YTvZh0tiHoC8hGfknKnk2IUMYhQoIxgcQ" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=tigerowo/freedom&type=date&legend=top-left&sealed_token=SMYnxdZ99ogoiNPY5Qaeg1X9nB17KGpOCvv0Pzjz5mLCx5o7pNOpQNnYpk2CIUkdJMuAcxve8H_ZAYllKY4b7YTvZh0tiHoC8hGfknKnk2IUMYhQoIxgcQ" />
 </picture>
</a>
